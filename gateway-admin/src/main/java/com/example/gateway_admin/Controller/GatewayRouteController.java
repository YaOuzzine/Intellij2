...
public class GatewayRouteController {
    ...
    @Autowired
    public GatewayRouteController(GatewayRouteService gatewayRouteService, DataSyncService dataSyncService) {
    ...
    public GatewayRoute createRoute(@RequestBody GatewayRoute route) {
        GatewayRoute newRoute = gatewayRouteService.createRoute(route);
        // Trigger an immediate sync after creating a route
    ...
    public ResponseEntity<GatewayRoute> updateRoute(@PathVariable Long id, @RequestBody GatewayRoute updatedRoute) {
        ...
        // Trigger an immediate sync after updating a route
        dataSyncService.syncRoutesToGatewaySchema();
    ...
    public ResponseEntity<GatewayRoute> patchRoute(@PathVariable Long id, @RequestBody Map<String, Object> updates) {
        ...
        // Trigger an immediate sync after patching a route
        dataSyncService.syncRoutesToGatewaySchema();
    ...
    public ResponseEntity<Void> deleteRoute(@PathVariable Long id) {
        ...
        // Trigger an immediate sync after deleting a route
        dataSyncService.syncRoutesToGatewaySchema();
