...
const SystemSettingsPage = () => {
  ...
  const loadUserProfile = async () => {
    ...
    try {
      ...
      showNotification(
          error.response?.data?.message || 'Error loading user profile',
          'error'
      );
    } finally {
      setLoading(false);
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      updateUserContextProfile(response.data);
  ...
  const handleUploadPicture = async () => {
    ...
    try {
      ...
      // For now, simulate success and use local preview
      ...
      <Box sx={{ p: { xs: 2, md: 3 } }}>
                ...
                <Grid item xs={12} md={4}>
                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                    <Box sx={{ position: 'relative', mb: 2 }}>
                      <ProfileAvatar src={profileImage || undefined}>
                        {getInitials()}
                      </ProfileAvatar>
                      <UploadButton
                          variant="contained"
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {profileData.jobTitle || 'Job Title Not Set'}
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <TextField
                      ...
                      helperText={passwordErrors.newPassword || 'Min 8 characters'}
                      InputProps={{
                        endAdornment: (
                            <InputAdornment position="end">
              ...
              <Grid container spacing={3}>
                  ...
                  <Card variant="outlined">
                    <CardContent>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                        <VerifiedUserIcon color="primary" sx={{ mr: 2, mt: 0.5 }} />
                        <Box>
                ...
                <Grid item xs={12}>
                  <Card variant="outlined">
                    <CardContent>
                      <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                        <NotificationsIcon color="primary" sx={{ mr: 2, mt: 0.5 }} />
                        <Box>
                          <Typography variant="subtitle1" fontWeight="medium">
                            Email Notifications
                          </Typography>
                        ...
                        {loading && filteredUsers.length === 0 ? (
                            ...
                            filteredUsers.map((u) => (
                                <TableRow
                                    key={u.id}
                                    hover
                                    sx={{ opacity: u.status === 'Disabled' ? 0.7 : 1 }}
                                >
                                  ...
                                  <TableCell>
                                    <Chip
                                        icon={u.status === 'Active' ? <CheckCircleIcon /> : <BlockIcon />}
                                        label={u.status}
                                  ...
                                  <TableCell align="right">
                                    <IconButton
                                        onClick={(e) => handleOpenUserActionsMenu(e, u.id)}
                                        size="small"
                                    >
                                      <MoreVertIcon />
                                    </IconButton>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box>
              <Typography variant="h6" fontWeight="medium">Account Management</Typography>
              <Typography variant="body2" color="text.secondary">Log out of your account.</Typography>
            </Box>
            <Button
                variant="outlined"
                color="error"
          ...
          <DialogContent>
            <Box sx={{ textAlign: 'center', my: 2 }}>
              ...
              <Typography variant="caption" display="block" sx={{ mt: 1 }}>
                Square image, 200x200 pixels recommended
              </Typography>
            </Box>
          </DialogContent>
          <DialogActions>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <TextField
                      ...
                      helperText={newUserErrors.password || 'Min 8 characters'}
                      required
                      InputProps={{
                        endAdornment: (
                            <InputAdornment position="end">
        ...
        >
          ...
          <MenuItem onClick={() => { setConfirmDeleteDialog(true); }}>
            <ListItemIcon>
        ...
        >
          ...
          <DialogContent>
            ...
            <Typography>
              Delete user {users.find(u=>u.id === selectedUserId)?.username || ''}?
            </Typography>
          </DialogContent>
          <DialogActions>
            ...
            <Button
                ...
                disabled={loading}
            >
              {loading ? <CircularProgress size={24} color="inherit"/> : 'Delete User'}
            </Button>
          </DialogActions>
        </Dialog>
